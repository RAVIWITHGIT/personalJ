...
public class stringMethod{
    public static void main(String args[]){
        ...
        */
        ...
        this method take two parameter startingIndex and endingIndex --> substring(start,end)
         */
        ...
        3. also we can set index where do he start string , in this case when give index he forget after index and the starting point which index we give and go givenIndex to startingIndex point. 
